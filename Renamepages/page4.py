...
def app():
    ...
    with top:
        ...
        with colll1:
            ...
            st.header("Installed Location: 1764 Ramp #288")
            st.header("Pipe Material: Steel Pipe")
    ...
    with col1:
        ...
        with tab1:
            ...
            delta_thickness1 = str(sensor1_lines-10) + " mm"
        ...
        with tab2:
            ...
            delta_thickness2 = str(sensor2_lines-10) + " mm"
            hktimez = pytz.timezone("Asia/Hong_Kong") 
            timenowhk = datetime.now(hktimez)
            st.markdown("Last Reporting Date and Time: " + timenowhk.strftime('%Y-%m-%d %H:%M:%S'))
            st.markdown("###")
        ...
        with tab3:
            ...
            current_thickness3 = str(sensor3_lines) + " mm"
            delta_thickness3 = str(sensor3_lines-10) + " mm"
            hktimez = pytz.timezone("Asia/Hong_Kong") 
            timenowhk = datetime.now(hktimez)
            st.markdown("Last Reporting Date and Time: " + timenowhk.strftime('%Y-%m-%d %H:%M:%S'))
            st.markdown("###")
        ...
        with tab4:
            ...
            current_thickness4 = str(sensor4_lines) + " mm"
            delta_thickness4 = str(sensor4_lines-10) + " mm"
            hktimez = pytz.timezone("Asia/Hong_Kong") 
            timenowhk = datetime.now(hktimez)
            st.markdown("Last Reporting Date and Time: " + timenowhk.strftime('%Y-%m-%d %H:%M:%S'))
            st.markdown("###")
            st.markdown("###")
            st.metric(label="Current State", value=current_thickness4, delta=delta_thickness4)
    with col3:
        # echats
        st.image('page2.png', caption='Sensor Installation Schematic')
